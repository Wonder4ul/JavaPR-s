...
public class SortingStudentsByGPA implements Comparator {
    ...
    public void exThree() {
        Student[] students1 = new Student[]{
                new Student("St10","Sn10","prog",3,"inbo",10),
                new Student("St9","Sn9","prog",3,"inbo",9),
                new Student("St5","Sn5","prog",3,"inbo",5),
                new Student("St4","Sn4","prog",3,"inbo",4),
        };
        Student[] students2 = new Student[]{
                new Student("St3","Sn3","prog",3,"inbo",3),
                new Student("St7","Sn7","prog",3,"inbo",7),
                new Student("St1","Sn1","prog",3,"inbo",1),
                new Student("St2","Sn2","prog",3,"inbo",2),
        };
