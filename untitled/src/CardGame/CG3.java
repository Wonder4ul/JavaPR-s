...
public class CG3 {
    ...
    public CG3(String fp, String sp) {
    ...
    public static void main(String[] args) {
        System.out.println(new CG3("13579", "24680").play());
        System.out.println(new CG3("12345", "67890").play());
        System.out.println(new CG3("13029", "42685").play());
    }
