...
public class CG4 {
    ...
    public CG4(String fp, String sp) {
    ...
    public static void main(String[] args) {
        System.out.println(new CG4("13579", "24680").play());
        System.out.println(new CG4("12345", "67890").play());
        System.out.println(new CG4("13029", "42685").play());
    }
