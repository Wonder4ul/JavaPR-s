...
public class CG2 {
    ...
    public CG2(String fp, String sp) {
    ...
    public static void main(String[] args) {
        System.out.println(new CG2("13579", "24680").play());
        System.out.println(new CG2("12345", "67890").play());
        System.out.println(new CG2("13029", "42685").play());
    }
